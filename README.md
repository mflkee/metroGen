...
- **tests/** — см. реализацию моков Arshin (`respx`) и примеры использования сервисов.

Готово! Теперь README содержит все шаги по разворачиванию и эксплуатации сервиса. Успешной генерации протоколов ✨
