...
│   ├── attachments
│   ├── input
│   └── verification_methods_202510201601.json
├── migrations/
│   ├── versions/
...
│   ├── import_verification_methods.py
...
### 7. `.uv-cache/CACHEDIR.TAG`

```
Signature: 8a477f597d28d172789f06886806bc55
```

### 8. `.uv-cache/sdists-v9/.git`

```

```

### 9. `.uv-cache/sdists-v9/.gitignore`
...
### 17. `app/api/routes/__init__.py`

```python

```

### 18. `app/api/routes/arshin.py`
...
### 19. `app/api/routes/methodologies.py`
...
### 20. `app/api/routes/protocols.py`
...
### 23. `app/core/__init__.py`

```python

```

### 24. `app/core/config.py`
...
### 26. `app/data/__init__.py`

```python

```

### 27. `app/data/mappings.py`
...
### 28. `app/data/methodologies.json`
...
### 32. `app/db/repositories/__init__.py`
...
### 33. `app/db/repositories/core.py`
...
### 34. `app/db/repositories/utils.py`
...
### 38. `app/schemas/__init__.py`

```python

```

### 39. `app/schemas/arshin.py`
...
### 42. `app/services/__init__.py`

```python

```

### 43. `app/services/arshin_client.py`
...
### 45. `app/services/generators/base.py`
...
### 46. `app/services/generators/controller_43790_12.py`
...
### 47. `app/services/generators/pressure_common.py`
...
### 48. `app/services/generators/registry.py`
...
### 49. `app/services/html_renderer.py`
...
### 52. `app/services/protocol_builder.py`
...
### 53. `app/services/registry_ingest.py`
...
### 55. `app/templates/controller_43790_12.html`
...
### 56. `app/templates/manometer.html`
...
### 57. `app/utils/__init__.py`

```python

```

### 58. `app/utils/excel.py`
...
### 62. `data/attachments/Davlenie.html`
...
### 63. `data/attachments/DavlenieSuccessDocumentCreator.cs`
...
### 64. `data/attachments/DocumentCreatorBase.cs`
...
### 66. `data/attachments/HTMLCreationResult.cs`
...
### 67. `data/attachments/Manometr.html`
...
### 68. `data/attachments/ManometrDocumentCreator.cs`
...
### 69. `data/attachments/PageManipulationExtensions.cs`
...
### 70. `data/input/.~lock.Поверка манометры 06.2025 (copy 1).xlsm#`

```
,mflkee,archlinux-laptop,01.10.2025 11:18,file:///home/mflkee/.config/libreoffice/4;
```

### 71. `data/input/.~lock.Поверка манометры 06.2025.xlsm#`

```
,mflkee,archlinux-laptop,01.10.2025 11:11,file:///home/mflkee/.config/libreoffice/4;
```

### 72. `data/verification_methods_202510201601.json`

```json
{
"verification_methods": [
	{
		"id" : "019882fe-58c7-7b69-8702-a69245d2a8a8",
		"aliases" : "{\"МИ 4212-012-2001\"}",
		"description" : "МИ 4212-012-2001 \"Датчики (измерительные преобразователи) давления типа \"Метран\"\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3-5.4\"}}"
	},
	{
		"id" : "01981d30-13e9-776b-9a4c-119529d4662d",
		"aliases" : "{\"МИ 2124-90\"}",
		"description" : "МИ 2124-90 «ГСИ. Манометры, вакуумметры, мановакуумметры, напоромеры, тягомеры и тягонапоромеры показывающие и самопишущие. Методика поверки»",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2.3\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"5.3\"}}"
	},
	{
		"id" : "01987a02-fe19-73d1-8a74-4958446db974",
		"aliases" : "{\"МП 4212-021-2015\"}",
		"description" : "МП 4212-021-2015 «Преобразователи давления измерительные 3051. Методика поверки», утвержденному ФБУ «Челябинский ЦСМ» 02.02.2015 г.",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Проверка программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"5.3\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.4\"}}"
	},
	{
		"id" : "019879d2-d4e6-745c-957e-062f0ca5033c",
		"aliases" : "{\"МИ 14061-10\",\"МП 14061-10 ПРЕОБРАЗОВАТЕЛИ ДАВЛЕНИЯ ИЗМЕРИТЕЛЬНЫЕ 3051. МЕТОДИКА ПОВЕРКИ\"}",
		"description" : "МП 14061-10 «Преобразователи давления измерительные 3051. Методика поверки», утвержденному ГЦИ СИ ФГУП «ВНИИМС» 08.02.2010 г.",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3\"}}"
	},
	{
		"id" : "0198833c-5b57-7e63-b0bd-9a4aca1af9fa",
		"aliases" : "{\"МП 202-007-2021\"}",
		"description" : "МП 202-007-2021 \"ГСИ. Преобразователи давления измерительные 3051S. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.2\"},\"Проверка программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"9\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"10-11\"}}"
	},
	{
		"id" : "01988341-541f-7b41-ae37-34b22a34729e",
		"aliases" : "{\"МП 02-2023-20\"}",
		"description" : "МП 02-2023-20 \"ГСИ. Датчики давления Метран-150. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8\"},\"Проверка программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"9\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"10\"}}"
	},
	{
		"id" : "01981d49-69f4-785e-bfcd-5b1bb276b637",
		"aliases" : "{\"МП 25511-0029-2015\"}",
		"description" : "МП 25511-0029-2015 Манометры деформационные PG23LT, PG23CP, PG43SA Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"6.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"6.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"6.3\"}}"
	},
	{
		"id" : "01982ca2-d96a-73ba-a0d4-74cd7859c03d",
		"aliases" : "{\"МП 25511-0022-2013\",МП-25511-0022-2013,МП-255511-0022-2013}",
		"description" : "МП 25511-0022-2013 \"Манометры деформационные дифференциального давления серии 7\" Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"7.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"7.3\"}}"
	},
	{
		"id" : "01982cb0-3053-72ef-9976-0de0d5435286",
		"aliases" : "{\"МИ 925-85\"}",
		"description" : "МИ 925-85 “ГСИ Манометры, вакуумметры и мановакуумметры показывающие и самопишущие” Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"4.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"4.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"4.2.4\"}}"
	},
	{
		"id" : "019879d7-3ea2-7ba1-8730-8b3dcd5133e9",
		"aliases" : "{\"МИ 1997\",\"МИ 1997-89\",\"МИ 1997-89 ГСИ. ПРЕОБРАЗОВАТЕЛИ ДАВЛЕНИЯ ИЗМЕРИТЕЛЬНЫЕ. МЕТОДИКА ПОВЕРКИ\"}",
		"description" : "МИ 1997-89 «Преобразователи давления измерительные. Методика поверки».",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3-5.4\"}}"
	},
	{
		"id" : "01987a19-4111-744e-b9f8-7f38db3d6a0f",
		"aliases" : "{\"МП 56868-15\",\"МП 59868-15\",\"МП 59868-15 С ИЗМЕНЕНИЕМ 4\"}",
		"description" : "МП 59868-15 «Преобразователи (датчики) давления измерительные EJ*. Методика поверки» с изменением № 4, утвержденному ФГУП «ВНИИМС» 06.07.2020 г",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3-5.4\"}}"
	},
	{
		"id" : "0198834f-44d0-79ac-afde-504c46ff11fa",
		"aliases" : "{МП-03-2018-20}",
		"description" : "МП 03-2018-20 \"Датчики давления Агат-100МТ. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"8.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.2\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"8.3-8.4\"}}"
	},
	{
		"id" : "019854ea-1d39-7809-9524-fbf60cb98795",
		"aliases" : "{\"МИ 2124-09\"}",
		"description" : "МИ 2124-90 «ГСИ. Манометры, вакуумметры, мановакуумметры, напоромеры, тягомеры и тягонапоромеры показывающие и самопишущие. Методика поверки»",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2.3\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"5.3\"}}"
	...
	{
		"id" : "019854fc-9d45-7928-b8d4-6e1f16da4e1a",
		"aliases" : "{РТ-МП-1077-443-2024}",
		"description" : "РТ-МП-1077-443-2024 \"ГСИ Манометры МПю, ЭкМю Методика поверки\"",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.4\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"9.1\"}}"
	},
	{
		"id" : "019873ab-ed17-78cd-9ff7-b1c15f03d6c8",
		"aliases" : "{\"ПРЕОБРАЗОВАТЕЛИ ДАВЛЕНИЯ ИЗМЕРИТЕЛЬНЫЕ EJX. МЕТОДИКА ПОВЕРКИ.\",\"ГСИ. ПРЕОБРАЗОВАТЕЛИ ДАВЛЕНИЯ ИЗМЕРИТЕЛЬНЫЕ EJX. МЕТОДИКА ПОВЕРКИ\",\"ГЦИ. ПРЕОБРАЗОВАТЕЛИ ДАВЛЕНИЯ ИЗМЕРИТЕЛЬНЫЕ EJX. МЕТОДИКА ПОВЕРКИ\"}",
		"description" : "ГСИ Преобразователи давления измерительные EJX. Методика поверки",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3\"}}"
	},
	{
		"id" : "019879ee-0d9a-7f94-903b-e7f080d83179",
		"aliases" : "{\"МП 4212-012-2013\",\"МП 4212-012-2013 ДАТЧИКИ ДАВЛЕНИЯ МЕТРАН-150. МЕТОДИКА ПОВЕРКИ\"}",
		"description" : "МП 4212-012-2013 \"ГСИ Датчики давления Метран-150. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат внешнего опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Проверка идентификационных данных ПО\":{\"Type\":\"Yes_No\",\"Value\":\"5.6\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3,5.4\"}}"
	},
	{
		"id" : "01987d71-3349-7940-b667-baadf34ba5cb",
		"aliases" : "{\"МП 24116-13\"}",
		"description" : "МП 24116-13 \"ГСИ Преобразователи давления измерительные 3051S. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.4\"}}"
	},
	{
		"id" : "01987eba-9cbf-7e75-b28d-7f5b8d9247d7",
		"aliases" : "{\"МИ 2596-2000\"}",
		"description" : "МИ 2596-2000 \"ГСИ Преобразователи давления измерительные EJA. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.3-5.4\"}}"
	},
	{
		"id" : "01981d4e-8014-7ede-94e0-4e32911b7de9",
		"aliases" : "{\"МП 59554-14\"}",
		"description" : "МП 59554-14 Манометры МП, НП, ЭКН и ЭКМ, вакуумметры ВП, ТП, ЭКТ и ЭКВ, мановакуумметры МВП, ТНП и ЭКМВ, дифманометры ДП и ЭКД показывающие и сигнализирующие. Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"9.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"9.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"9.3\"}}"
	},
	{
		"id" : "01981d55-db5e-7381-929a-6919326c9a46",
		"aliases" : "{\"МП 5Ш0.283.421\"}",
		"description" : "МП 5Ш0.283.421 Манометры, вакуумметры и мановакуумметры показывающие для точных измерений МПТИ, ВПТИ и МВПТИ",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"8.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"8.3\"}}"
	},
	{
		"id" : "01982c43-bba9-76a2-a73e-4ee5cda17772",
		"aliases" : "{\"МП 4212-114-64115539-2022\",\"МП 4212-114-64115539-2023\",\"МП 4212-114-64115539-2024\",\"МП 4212-114-64115539-2025\",\"МП 4212-114-64115539-2026\",\"МП 4212-114-64115539-2027\",\"МП 4212-114-64115539-2028\",\"МП 4212-114-64115539-2029\",\"МП 4212-114-64115539-2022 СТБ 8056-2015\"}",
		"description" : "МП 4212-114-64115539-2022 «ГСИ. Манометры, вакуумметры, мановакуумметры, напоромеры, тягомеры и тягонапоромеры ФТ. Методика поверки»",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"6\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"8.2\"}}"
	},
	{
		"id" : "01982c6f-3073-7357-95af-6fd0cbb71e07",
		"aliases" : "{\"МАНОМЕТРЫ МП НП ЭКН И ЭКМ ВАКУУММЕТРЫ ВП ТП ЭКТ И ЭКВ. МП\",\"МАНОМЕТРЫ МП НП ЭКН И ЭКМ ВАКУУММЕТРЫ ВП ТП ЭКТ . МЕТОДИКА ПОВЕРКИ\"}",
		"description" : "\"Манометры МП, НП, ЭКН и ЭКМ, вакуумметры ВП, ТП, ЭКТ и ЭКВ, мановакуумметры МВП, ТНП, ЭКТН, ЭКМВ, дифманометры ДП и ЭКД показывающие и сигнализирующие\" Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"9.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"9.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"9.3\"}}"
	},
	{
		"id" : "019879fc-00dc-7766-aea6-a3d02f78c3e0",
		"aliases" : "{\"МП 4212-023-2011\"}",
		"description" : "МП 4212-023-2011 \"ГСИ Датчики давления Метран-75. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Проверка идентификационных данных ПО\":{\"Type\":\"Yes_No\",\"Value\":\"5.3\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"5.4,5.5\"}}"
	},
	{
		"id" : "01983727-401e-7061-9362-72928e673e64",
		"aliases" : "{\"МП РТ 1840-2012\"}",
		"description" : "МП РТ 1840-2012 \"ГСИ Манометры дифференциальные показывающие Magnehelic, Capsuhelic, Minihelic II, Photohelic, Capsu-Pнотонеlic и Mini-Photohelic марки Dwyer\" Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"5.5\"}}"
	},
	{
		"id" : "019854d8-3507-79db-aaad-c520288ad926",
		"aliases" : "{\"МП 4212-117-64115539-2016\"}",
		"description" : "МП 4212-117-64115539-2016 \"Манометры, вакуумметры, мановакуумметры точных измерений МТИф, ВТИф, МВТИф\" Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"5.3\"}}"
	},
	{
		"id" : "019879ff-3ec7-7147-9050-5d7dfc54bfe4",
		"aliases" : "{\"МП 15-221-2012\"}",
		"description" : "МП 15-221-2012 \"ГСИ. Датчики давления. Агат-100 М. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"8.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.2\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"8.3,8.4\"}}"
	},
	{
		"id" : "01987ee4-c15a-7963-89b4-8fa03542476e",
		"aliases" : "{МП-068-2022}",
		"description" : "МП-068-2022 \"ГСИ Датчики давления Метран-75. Методика поверки\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8\"},\"Проверка программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"9\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"10.2-11\"}}"
	},
	{
		"id" : "019830db-2c6b-7aca-9316-ada858f959d9",
		"aliases" : "{\"271.01.000 РЭ\",\"271.01.00.000 РЭ РАЗ. 3.4\",\"271.01.00.000 РЭ РАЗДЕЛ 3.4\",\"РАЗДЕЛ 3.4 271.01.00.000 РЭ\",\"РАЗДЕЛ 3.4 ДОКУМЕНТА 271.01.00.000 РЭ\",\"РАЗДЕЛ 3.4 МЕТОДИКА ПОВЕРКИ ДОКУМЕНТА 271.01.00.000 РЭ\",\"РАЗДЕЛ 3.4 РУКОВОДСТВА ПО ЭКСПЛУАТАЦИИ 271.01.00.000 РЭ\"}",
		"description" : "РЭ 271.01.00.000 \"Термопреобразователи с унифицированным выходным сигналом Метран-270, Метран-270-Ex\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"3.4.5.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"3.4.5.2\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"3.4.5.4\"}}"
	},
	{
		"id" : "0198e541-444a-7f22-b574-3590defe056f",
		"aliases" : "{\"МП 26221-08\"}",
		"description" : "МП 26221-08 \"Термометры биметаллические БТ. Методика поверки\"",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"п. 5.1 методики поверки МП 26221-08\"}}"
	},
	{
		"id" : "019909a3-3cf8-7401-bbbf-d03905a0a390",
		"aliases" : "{НКГЖ.406233.053МП}",
		"description" : "НКГЖ.406233.053МП \"Манометры электронные ЭТМ. Методика поверки\"",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"8.1\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"8.3\"},\"Определение основной приведенной погрешности и вариации\":{\"Type\":\"Yes_No\",\"Value\":\"8.6\"}}"
	},
	{
		"id" : "01982c9c-9914-7b68-9e1f-98a8b89a9bf4",
		"aliases" : "{\"МП 406121-2018\",\"МП 406121-2018 С ИЗМЕНЕНИЕМ 1\"}",
		"description" : "МП 406121-2018 \"ГСИ. Манометры показывающие ТМ, ТВ, ТМВ и ТМТБ\" Методика поверки",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Результат опробования\":{\"Type\":\"Yes_No\",\"Value\":\"9\"},\"Определение основной погрешности\":{\"Type\":\"Fact\",\"Value\":\"10\"}}"
	},
	{
		"id" : "01993c58-2d42-7317-9778-0f685430e8c5",
		"aliases" : "{\"ГОСТ 15614-70\"}",
		"description" : "ГОСТ 15614-70 \"Манометры, вакуумметры и мановакуумметры показывающие и самопишущие.\"",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Результат внешнего осмотра\":{\"Type\":\"Yes_No\",\"Value\":\"4.1-4.6\"},\"Проверка положения стрелки у нулевой отметки\":{\"Type\":\"Yes_No\",\"Value\":\"4.2.1-4.2.2\"},\"Установка стрелки на нулевую отметку\":{\"Type\":\"Yes_No\",\"Value\":\"4.2.2\"},\"Определение разности показаний стрелок двухстрелочных приборов\":{\"Type\":\"Yes_No\",\"Value\":\"4.2.19\"},\"Определение перестановочного усилия контрольной стрелки\":{\"Type\":\"Yes_No\",\"Value\":\"4.3.2-4.3.3\"},\"Определение погрешности и вариации\":{\"Type\":\"Fact\",\"Value\":\"4.2\"}}"
	},
	{
		"id" : "01999431-94b5-73fc-ba8c-0655270d925c",
		"aliases" : "{МПУ,\"МПУ 00304-2003\"}",
		"description" : "МПУ 003\/04-2003 \"Манометры, вакуумметры, мановакуумметры, напоромеры, тягомеры и тягонапоромеры показывающие и самопишущие\"",
		"protocol_template_id" : "01981d3d-8e8b-7bf2-a37f-1b07fd2de2f6",
		"checkups" : "{\"Внешний осмотр\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Опробование\":{\"Type\":\"Yes_No\",\"Value\":\"5.4\"},\"Контроль герметичности\":{\"Type\":\"Yes_No\",\"Value\":\"5,5\"},\"Контроль метрологических характеристик\":{\"Type\":\"Fact\",\"Value\":\"5.6\"}}"
	},
	{
		"id" : "01999a89-3a07-7538-8088-bc59376b8417",
		"aliases" : "{\"МП 50367-12 C ИЗМ. 1\"}",
		"description" : "МП 50367-12 С изменением 1 \"Преобразователи давления измерительные беспроводные EJX (серия В)\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Внешний осмотр\":{\"Type\":\"Yes_No\",\"Value\":\"5.1\"},\"Опробование\":{\"Type\":\"Yes_No\",\"Value\":\"5.2\"},\"Определение основной погрешности и вариации преобразователя\":{\"Type\":\"Fact\",\"Value\":\"5.3-5.4\"}}"
	},
	{
		"id" : "01999a69-ca98-7d59-a320-9ee3f3d40624",
		"aliases" : "{\"МЦКЛ.0132 МП\",\"МЦКЛ.0132 АМ-2000\"}",
		"description" : "МЦКЛ.0132 \"Датчики давления серии АМ-2000\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Внешний осмотр\":{\"Type\":\"Yes_No\",\"Value\":\"6.1\"},\"Опробование\":{\"Type\":\"Yes_No\",\"Value\":\"6.2\"},\"Определение основной погрешности\":{\"Type\":\"Yes_No\",\"Value\":\"6.3\"},\"Определение вариации выходного сигнала\":{\"Type\":\"Yes_No\",\"Value\":\"6.4\"},\"Определение соответствия программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"6.5\"}}"
	},
	{
		"id" : "0199a437-b590-7e21-9cce-f72578e8ffb2",
		"aliases" : "{\"НКГЖ.406233.028 МП\"}",
		"description" : "НКГЖ.406233.028 МП \"Преобразователи давления измерительные АИР-20\/М2\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Внешний осмотр\":{\"Type\":\"Yes_No\",\"Value\":\"6.1\"},\"Проверка герметичности системы\":{\"Type\":\"Yes_No\",\"Value\":\"6.2\"},\"Опробование\":{\"Type\":\"Yes_No\",\"Value\":\"6.3\"},\"Проверка электрической прочности изоляции\":{\"Type\":\"Yes_No\",\"Value\":\"6.4\"},\"Проверка электрического сопротивления изоляции\":{\"Type\":\"Yes_No\",\"Value\":\"6.5\"},\"Определение основной приведенной погрешности для конкретного диапазона измерений для преобразователей\":{\"Type\":\"Fact\",\"Value\":\"6.7\"}}"
	},
	{
		"id" : "0199a444-f8ff-7ab3-b958-b40677b3a701",
		"aliases" : "{\"КУВФ.406230.100 МП\"}",
		"description" : "КУВФ.406230.100 МП \"Преобразователи давления измерительные ОВЕН ПД100\"",
		"protocol_template_id" : "019840bf-25b1-7253-aecd-7605dbaee6ab",
		"checkups" : "{\"Внешний осмотр\":{\"Type\":\"Yes_No\",\"Value\":\"7\"},\"Подготовка к поверке и опробование\":{\"Type\":\"Yes_No\",\"Value\":\"8\"},\"Проверка программного обеспечения\":{\"Type\":\"Yes_No\",\"Value\":\"9\"},\"Определение метрологических характеристик\":{\"Type\":\"Fact\",\"Value\":\"10\"}}"
	}
]}

```

### 73. `migrations/env.py`
...
### 74. `migrations/versions/20250906_000001_init.py`
...
### 75. `migrations/versions/20251001_000002_data_model.py`
...
### 76. `migrations/versions/20251001_000003_methodology.py`
...
### 77. `migrations/versions/20251010_000004_add_instrument_kind.py`
...
### 80. `scripts/__init__.py`

```python
# Mark scripts as a package for intra-repo imports.

```

### 81. `scripts/bootstrap_database.py`
...
### 82. `scripts/import_verification_methods.py`
...
### 83. `scripts/run_quality_checks.py`
...
### 85. `tests/test_arshin_routes.py`
...
### 86. `tests/test_arshin_service.py`
...
### 88. `tests/test_methodologies_routes.py`
...
### 90. `tests/test_protocols_html.py`
...
### 91. `tests/test_protocols_routes.py`
...
### 92. `tests/test_registry_ingest.py`
...
### 93. `tests/test_repository_utils.py`
